...
function[] = finalrun(config, dolinearreg, dosvr, dolasso, doclassifyfinger)

% clean things
clearvars -except config dolinearreg dosvr dolasso doclassifyfinger
clc;
close all;
...
for patient = 1:3
        predicted_dg{patient} = (predicted_dg_lin{patient} + predicted_dg_lasso{patient})/2.0;
end
