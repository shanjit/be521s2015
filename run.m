...
features_test = getFeatures('test_data');
features_train = getFeatures('train_data');


% Step 3: apply models and make predictions

% Step 3.1: Apply linear models
linweights = getLinWeights(features_train);
predictions = getLinPredictions(linweights, features_test);
